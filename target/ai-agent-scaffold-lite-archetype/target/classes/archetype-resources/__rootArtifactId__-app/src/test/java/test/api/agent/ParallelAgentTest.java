...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.test.api.agent;
                        ...
                        .instruction(
                                """
                                      ...
                                      **Output Format:**
                                      ...
                                      ${symbol_pound}${symbol_pound} Summary of Recent Sustainable Technology Advancements
               
                                      ${symbol_pound}${symbol_pound}${symbol_pound} Renewable Energy Findings
                                      (Based on RenewableEnergyResearcher's findings)
                                      [Synthesize and elaborate *only* on the renewable energy input summary provided above.]
               
                                      ${symbol_pound}${symbol_pound}${symbol_pound} Electric Vehicle Findings
                                      (Based on EVResearcher's findings)
                                      [Synthesize and elaborate *only* on the EV input summary provided above.]
               
                                      ${symbol_pound}${symbol_pound}${symbol_pound} Carbon Capture Findings
                                      (Based on CarbonCaptureResearcher's findings)
                                      [Synthesize and elaborate *only* on the carbon capture input summary provided above.]
               
                                      ${symbol_pound}${symbol_pound}${symbol_pound} Overall Conclusion
