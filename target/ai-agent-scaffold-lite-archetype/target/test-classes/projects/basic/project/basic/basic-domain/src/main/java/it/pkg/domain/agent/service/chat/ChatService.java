package it.pkg.domain.agent.service.chat;

import it.pkg.domain.agent.model.entity.ChatCommandEntity;
import it.pkg.domain.agent.model.valobj.AiAgentConfigTableVO;
import it.pkg.domain.agent.model.valobj.AiAgentRegisterVO;
import it.pkg.domain.agent.model.valobj.properties.AiAgentAutoConfigProperties;
import it.pkg.domain.agent.service.IChatService;
